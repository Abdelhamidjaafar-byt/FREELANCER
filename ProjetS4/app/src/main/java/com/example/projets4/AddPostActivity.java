...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //validate if we came here to update post i.e came AdapterPost
    ...
    private void sendPostNotification(JSONObject notificationJo) {
                ...
                })
        {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", "key=AAAAqYUjQNA:APA91bFNeVSoInmqYQ4hcYPosAMQGWuGnA1foewIhM3kFafly4Ce60UusoTTjP_KMdlwNwuTdoZz2BOAqwmWBbQEa2lJDPKx_wuHa-OFGg-MX4Csx1SiqGq-G3c_ipvrFdkK-4-af1sL");//paste your fcm key here after "key="
