...
import com.example.projets4.adapters.AdapterComments;
import com.example.projets4.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.example.projets4.fileprovider",
                    file);
        }
        catch (Exception e){
